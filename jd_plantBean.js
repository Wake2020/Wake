...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "https://gitee.com/wake326/RandomShareCode/raw/master/JD_Plant_Bean.json",headers:{
      ...
      try {
        if (err) {
          ...
          $.get({url: `https://gitee.com/wake326/RandomShareCode/raw/master/JD_Plant_Bean.json`, 'timeout': 10000},(err, resp, data)=>{
