...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: "https://gitee.com/wake326/RandomShareCode/raw/master/JD_Pet.json",headers:{
      ...
      try {
        if (err) {
          ...
          $.get({url: `https://gitee.com/wake326/RandomShareCode/raw/master/JD_Pet.json`, 'timeout': 10000},(err, resp, data)=>{
